<?php
/*on load shows error message, lets me fill out form and "send" no email sent, reloads, error message goes away*/
/*
...
add_shortcode( 'sitepoint_contact_form', 'dm_shortcode', 'redirect');
