<?php
/*fail - sent email, loaded a strange looking version of this page without the form or anything below the header showing, when I refreshed that page, resent the email*/
/*
